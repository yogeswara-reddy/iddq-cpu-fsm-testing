...
## SW3 - fault_sel[1]
set_property PACKAGE_PIN P16 [get_ports {fault_sel_i[1]}]
...
## LED4 - fault_active (reuse LED3 pin since only 4 LEDs on Zybo)
set_property PACKAGE_PIN D18 [get_ports fault_active_o]
